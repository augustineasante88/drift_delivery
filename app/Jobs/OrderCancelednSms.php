...
class OrderCancelednSms implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $message = "
        Hi $this->username, Your order number [$this->orderId] has been canceled successfully. We hope we'll see you again...right? :). Thank you.";
