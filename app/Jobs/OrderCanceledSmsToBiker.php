...
class OrderCanceledSmsToBiker implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $message = "
        Hi $this->username, The order number [$this->orderId] assigned to you has been canceled by the recipient. Please log into your account to confirm. Thank you.";
