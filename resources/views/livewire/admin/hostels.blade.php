    ...
    <div class="min-w-screen my-12 bg-gray-100 flex items-center justify-center font-sans">
        <div class="w-full lg:w-5/6">
            <div class='w-full lg:w-5/6 my-4'>
                <x-button rounded dark label="Add New Hostel" wire:click='openAddHostelModal' />
            </div>
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                <div class="flex items-center">
                                    <span class="font-medium">{{$hostel->name}}</span>
                                </div>
                            </td>
...
<x-modal wire:model.defer="addHostelModal">
    <x-card title="Add New Hostel">
        <div class='mt-2' >
        ...
        <x-slot name="footer">
            <div class="flex justify-end gap-x-4">
                ...
                <x-button rounded primary label="save" wire:click='addHostel' />
            </div>
        </x-slot>
    </x-card>
</x-modal>
