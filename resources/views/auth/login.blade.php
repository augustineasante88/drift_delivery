    ...
    <x-jet-authentication-card>
        <x-slot name="logo">
            ...
            <a href="/" title="" class="flex font-bold text-blue-900 text-4xl">
                <img src='{{asset("my-assets/images/drift.png")}}' class='h-60 w-96'/>
            </a>
        </x-slot>
